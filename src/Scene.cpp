...
void Scene::init()
{
    ...
    this->gameState->builder1 = new Builder(500,200, 100, 100);
    ...
    this->gameState->texts.push_back(this->gameState->makeText("", 100, 100));
    this->gameState->texts.push_back(this->gameState->makeText("", 200, 100));
    this->gameState->texts.push_back(this->gameState->makeText("", 300, 100));
    this->gameState->texts.push_back(this->gameState->makeText("", 400, 200));
}
